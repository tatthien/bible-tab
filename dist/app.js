...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_scss__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setting__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setting___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__setting__);
...
new __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */]({
  ...
  data: {
    ...
    verse: null,
    locale: __WEBPACK_IMPORTED_MODULE_2__setting___default.a.get('locale', 'vi'),
    locales: [{ key: 'vi', title: 'VB1925 - Vietnamese' }, { key: 'en', title: 'NIV - English' }],
    mode: 'random',
    selectedInterval: __WEBPACK_IMPORTED_MODULE_2__setting___default.a.get('interval', 0),
    interval: [{ time: 0, title: 'None' }, { time: 1, title: '1 hour' }, { time: 6, title: '6 hours' }, { time: 12, title: '12 hours' }, { time: 24, title: '1 day' }],
    isShowSetting: false,
  ...
  created() {
    if (this.selectedInterval == 0) {
      ...
      let savedTime = __WEBPACK_IMPORTED_MODULE_2__setting___default.a.get('cached_time');
      let now = Date.now();
      ...
      if (hourDiff > this.selectedInterval) {
        ...
        this.verse = JSON.parse(__WEBPACK_IMPORTED_MODULE_2__setting___default.a.get('cached_verse'));
      }
    }
  },
  watch: {
    selectedInterval() {
      __WEBPACK_IMPORTED_MODULE_2__setting___default.a.set('cached_time', Date.now());
    }
  },
  methods: {
    fetch() {
      fetch(this.verseEndpoint).then(response => {
        ...
        __WEBPACK_IMPORTED_MODULE_2__setting___default.a.set('cached_verse', JSON.stringify(this.verse));
        // reset the time
        __WEBPACK_IMPORTED_MODULE_2__setting___default.a.set('cached_time', Date.now());
      });
    },
    getRandomIndex(length) {
      ...
      let cachedIndex = __WEBPACK_IMPORTED_MODULE_2__setting___default.a.get('cached_index');
      if (index == cachedIndex) {
        this.getRandomIndex(length);
      }
      __WEBPACK_IMPORTED_MODULE_2__setting___default.a.set('cached_index', index);
      return index;
    },
    copyVerse() {
      this.isCopy = true;
    ...
    saveSettings() {
      ...
      for (let i = 0; i < fields.length; i++) {
        ...
        __WEBPACK_IMPORTED_MODULE_2__setting___default.a.set(name, value);
      }
